  ...
  <Dialog v-model:open="open">
    <DialogContent class="max-w-[92vw] sm:max-w-3xl">
      ...
      <div class="min-w-0 space-y-3 text-xs">
        <div class="rounded-md border border-border bg-muted/30 p-3 font-mono">
        ...
        <div v-if="ca?.exists" class="space-y-4 pt-1">
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-stretch gap-2">
              <code
                class="min-w-0 flex-1 overflow-x-auto whitespace-pre rounded bg-console px-2 py-1.5 font-mono text-console-foreground"
                >{{ macCommand }}</code
              >
