  ...
  >
    ...
    <div class="grid grid-cols-12 items-start gap-4">
      <aside class="col-span-12 lg:col-span-3">
        <div
          class="h-[70vh] rounded-lg border bg-card p-3 lg:sticky lg:top-28 lg:h-[calc(100vh-9.5rem)]"
        >
          <CollectionsSidebar
      ...
      <section class="col-span-12 flex flex-col gap-4 lg:col-span-9 lg:h-[calc(100vh-9.5rem)]">
        <div class="max-h-[60%] shrink-0 space-y-3 overflow-auto rounded-lg border bg-card p-3">
        ...
        <div class="min-h-0 flex-1 rounded-lg border bg-card p-3">
          <ResponsePanel
            :response="response"
            :loading="sending"
            :error="sendError"
