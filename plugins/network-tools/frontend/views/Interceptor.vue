  ...
  <ToolShell title="请求拦截" description="本地 MITM 代理：捕获、查看、编辑并重放 HTTP(S) 请求">
    ...
    <div class="grid grid-cols-12 items-start gap-4">
      <section class="col-span-12 lg:col-span-5">
        <div class="flex h-[calc(100vh-11rem)] flex-col gap-2 rounded-lg border bg-card p-3">
          ...
          <div class="min-h-0 flex-1 overflow-hidden rounded-md border border-border/60">
            ...
            <div v-else class="h-full overflow-auto">
              <button
                ...
                :key="item.id"
                type="button"
                class="flex w-full items-center gap-2 border-b border-border/50 px-2 py-1.5 text-left hover:bg-accent"
      ...
      <section class="col-span-12 lg:col-span-7">
        <div class="h-[calc(100vh-11rem)] overflow-hidden rounded-lg border bg-card p-3">
